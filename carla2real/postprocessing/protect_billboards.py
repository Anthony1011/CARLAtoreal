...
Usage:
  python -m carla2real.postprocessing.protect_billboards <in_mp4> <carla_rgb_dir> <rich_label_dir> <out_mp4> [alpha=0.85] [feather=3]
"""
import sys as _sys, os as _os
from carla2real.common.vidcodec import fourcc_for   # .avi -> lossless FFV1, anything else -> mp4v
